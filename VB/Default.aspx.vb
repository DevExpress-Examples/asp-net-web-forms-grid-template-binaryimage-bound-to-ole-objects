...
Namespace WebApplication1
    ...
    Public Partial Class _Default
        ...
        Const PNG_ID_BLOCK As String = Microsoft.VisualBasic.Strings.ChrW(137) & "PNG" & Microsoft.VisualBasic.Constants.vbCrLf & Microsoft.VisualBasic.Strings.ChrW(26) & Microsoft.VisualBasic.Constants.vbLf

        Const GIF_ID_BLOCK As String = "GIF8"

        Const TIFF_ID_BLOCK As String = "II*" & Microsoft.VisualBasic.Constants.vbNullChar

        Const DEFAULT_OLEHEADERSIZE As Integer = 78
